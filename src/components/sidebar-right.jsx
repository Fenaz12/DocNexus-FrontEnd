              ...
              <SidebarGroup>
                ...
                <SidebarGroupContent className="px-4 space-y-4">
                  <div
                    ...
                    className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-6 flex flex-col items-center justify-center gap-2 text-center hover:bg-muted/50 transition cursor-pointer relative"
                  >
                    ...
                    <Input
                      type="file"
                      multiple
                      accept=".pdf,.docx,.csv,.txt,.pptx,.md,.html,.png,.jpg,.jpeg"
